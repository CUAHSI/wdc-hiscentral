            ...
            <asp:FormView ID="FormView1" runat="server" DataSourceID="SqlDataSource1" Height="415px"
                ...
                <EditItemTemplate>
                 ...
                 <asp:Label ID="Label2" runat="server" Font-Bold="True" Style="z-index: 112; left: 25px; position: absolute; top: 9px"
                     Text="Service Title:" Font-Size="16px" Width="130px"></asp:Label>
                ...
                <ItemTemplate>
                    <div style="z-index: 100; left: 1px; width: 860px; position: absolute; top: 0px; height: 475px; background-color: #FFFFFF;">
                        <asp:Label ID="hiddenUserName" runat="server" Font-Bold="True" Style="z-index: 100; left: 575px; position: absolute; top: 5px"
                            Text='<%# Bind("UserName") %>' Font-Size="Larger" Width="117px"></asp:Label>

                        <div style="z-index: 139; top: 341px; left: 489px; position: absolute; width: 356px; height: 116px; overflow: auto;">
                        ...
                        <asp:Label ID="Label5" runat="server" Font-Bold="True" Style="z-index: 120; left: 19px; position: absolute; top: 92px"
                            Text="Source Info:" Font-Size="16px" Width="117px"></asp:Label>
                        <div style="z-index: 138; left: 488px; overflow: auto; width: 356px; position: absolute; top: 215px; height: 106px">
 ...
 <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" CommandName="SiteInfo"
     ...
     Text="List Variables" Width="106px" Font-Size="12px"></asp:LinkButton>
        ...
        <asp:LinkButton ID="LinkButton3" runat="server" CausesValidation="False" CommandName="SiteInfo"
            Height="19px" OnClick="upload_Click" Style="border-right: black thin solid; border-top: black thin solid; font-weight: bold; z-index: 114; left: 531px; border-left: black thin solid; color: blue; border-bottom: black thin solid; position: absolute; top: 686px; background-color: white; text-align: center; text-decoration: none"
