...
<body>
    <form id="form1" runat="server">
        ...
        <div style="position: absolute; top: 150px;">
            ...
            <h3><span>Clients per Month: </span>The number of unique ip addresses that accessed the GetValues service for this network for each month. IP addresses originating from SDSC are not counted</h3>
            ...
            <h3><span>Values per Month: </span>The total number of values retrieved from the Water One Flow webservices associated with this network. This chart's y axis uses a log scale.</h3>
