    ...
    <form id="form1" runat="server">
        ...
        <div>
            &nbsp;<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CentralHISConnectionString %>"
                SelectCommand="SELECT [NetworkID], [username], [NetworkName], [ServiceWSDL], [Organization], [IsPublic], [LastHarvested], [FrequentUpdates], [CreatedDate], [ProjectStatus], [NetworkVocab], [IsApproved], [ValueCount], [VariableCount], [SiteCount], [ServiceStatus] FROM [HISNetworks] where username != 'delete_me' ORDER BY [NetworkID]"></asp:SqlDataSource>
            ...
            <asp:HyperLink ID="HyperLink3" runat="server" Font-Bold="True" ForeColor="#0000C0"
                Height="19px" NavigateUrl="mailform.aspx" Style="z-index: 103; left: 716px; position: absolute; top: 165px"
                Width="65px">Email</asp:HyperLink>


            <asp:HyperLink ID="HyperLink6" runat="server" Font-Bold="True" ForeColor="#0000C0"
                Height="19px" NavigateUrl="~/admin/unmappedvariables.aspx" Style="z-index: 105; left: 789px; position: absolute; top: 154px"
                Width="136px">Unmapped Variables</asp:HyperLink>
            

            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" ForeColor="#0000C0"
                Height="19px" NavigateUrl="~/admin/UsageReportAllNetworks.aspx" Style="z-index: 105; left: 900px; position: absolute; top: 154px"
                Width="136px">Usage Report - All Networks</asp:HyperLink>                
