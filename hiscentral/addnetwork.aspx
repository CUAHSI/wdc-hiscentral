...
<body>
    <form id="form1" runat="server">
        ...
        <asp:Label ID="Label6" runat="server" Font-Bold="True" Style="z-index: 103; left: 129px; position: absolute; top: 298px"
            ...
            &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
          <asp:Label  Style="position: absolute; font-weight: bold; top: 470px;" runat="server" ID="lblInUse" ForeColor="Red" Text="The network name you supplied is already in use. Please supply a different value." Visible="false"></asp:Label>
        ...
        <input id="chkAccept" type="checkbox" style="z-index: 112; left: 236px; position: absolute; top: 506px"
