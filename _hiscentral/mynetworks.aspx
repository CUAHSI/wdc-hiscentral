...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowSorting="True"
            ...
            left: 0px; position: absolute; top: 198px; width: 100%;" DataKeyNames="NetworkID" OnRowCommand="GridView1_RowCommand" OnRowDataBound="GridView1_RowDataBound" >
            <FooterStyle BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <Columns>
                <asp:CommandField SelectText="Details" ShowSelectButton="True" />
                <asp:ButtonField Text="Test" />
                <asp:HyperLinkField runat="server" Text="Usage Report" NavigateUrl="~/report.aspx" />
