...
namespace MultiEndpoint_1_0
{
    class OD_Utils
    {
        ...
        public static WaterML10.SiteInfoResponseType ReadSiteInfoObject_1_0(string fileName)
        {
            ...
            {
                WaterML10.SiteInfoResponseType rt = (WaterML10.SiteInfoResponseType)formatter.Deserialize(s);
                return rt;
            }
        }
