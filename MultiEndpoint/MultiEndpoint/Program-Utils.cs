...
namespace MultiEndpoint
{
    class OD_Utils
    {
        ...
        public static int Insert(string table, string cols, string values,
            SqlConnection sqlConn, SqlTransaction sqlTrans = null)
        {
            SqlCommand cmd = new SqlCommand("INSERT INTO " + table + cols + " VALUES " + values, sqlConn, sqlTrans);
            return cmd.ExecuteNonQuery();
        }

        public static WaterML11.SiteInfoResponseType ReadSiteInfoObject_1_1(string fileName)
        {
            ...
            {
                WaterML11.SiteInfoResponseType rt = (WaterML11.SiteInfoResponseType)formatter.Deserialize(s);
                return rt;
            }
        }
